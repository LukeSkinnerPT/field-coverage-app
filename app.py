...
# Reset polygon when a new image is uploaded
...
# -----------------------------
# CLICK-TO-DEFINE PLAYING SURFACE
# -----------------------------
...
if click is not None:
    ...
    # Avoid duplicate clicks being added during reruns
...
# -----------------------------
# CONVERT POLYGON TO ORIGINAL IMAGE COORDINATES
# -----------------------------
points = st.session_state.polygon_points_display
polygon = None
...
# Newer Roboflow workflow endpoint
...
# Roboflow workflow responses usually come back as:
# {"outputs": [{...}], "profiler_trace": [...]}
